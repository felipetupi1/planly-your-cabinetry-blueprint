    ...
    <div className="grid sm:grid-cols-2 gap-6">
      {items.map((item) => (
        <button
          ...
          className="group text-left rounded-xl overflow-hidden border border-border hover:border-primary/30 transition-all hover:shadow-md"
        >
